/// Chooses which [DashboardRepository] `dashboard` runs on: the real
...
///
/// **To force Dashboard to fixtures:**
/// ```
/// flutter run --dart-define=LACASA_WORK_DASHBOARD_LIVE_API=false
/// ```
///
/// **To point Dashboard at a specific non-default API host:**
/// ```
/// flutter run \
...
final bool useLiveWorkDashboardApi = resolveUseLiveApi(
